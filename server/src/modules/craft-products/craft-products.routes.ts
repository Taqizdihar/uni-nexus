...
const productImageUpload = singleFileUpload(getStoragePolicy('product_image'), 'image');
const designUpload = singleFileUpload(getStoragePolicy('product_design'), 'file');
...
craftProductsRoutes.post('/design-files', requirePermission('craft.products.write'), designUpload, controller.uploadDesignFile);
...
craftProductsRoutes.post('/:id/image', requirePermission('craft.products.write'), productImageUpload, controller.uploadImage);
