...
export const payExpenseSchema = z.object({ treasury_account_id: z.number().int().positive(), payment_date: z.string().min(10).max(40), reference_number: z.string().max(190).nullable().optional(), direct_payment_confirmed: z.boolean().optional() });
