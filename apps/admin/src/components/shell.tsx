...
import { Activity, Bell, BookOpen, Box, Boxes, ChevronDown, ChevronRight, ClipboardCheck, ClipboardList, FlaskConical, FolderKanban, Gauge, Layers3, LogOut, Menu, MessageSquare, Package, Palette, Printer, ReceiptText, ScrollText, Settings2, ShieldCheck, SlidersHorizontal, Spool, Users, Wallet, X } from 'lucide-react';
