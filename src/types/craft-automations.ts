...
export interface DomainEventPage { items: DomainEventSummary[]; page: number; limit: number; total: number; total_pages: number; }
export interface DomainEventFilters { status?: string; module?: string; event?: string; search?: string; page?: number; limit?: number; }
