...
import { 
  ...
  FolderKanban, Briefcase, FileText, Settings, Bell, Calendar, 
  ChevronRight, ArrowRightLeft, FileArchive, ShieldAlert, Zap, 
  Database, Network, PackageSearch, HardDrive, CircleDollarSign
} from 'lucide-react';
...
const craftNav: NavGroup[] = [
  ...
  { label: 'BISNIS', items: [
    ...
    { name: 'Keuangan', icon: CircleDollarSign, path: '/app/craft/finance', subItems: [
      { name: 'Ringkasan Keuangan', path: '/app/craft/finance' },
      { name: 'Transaksi', path: '/app/craft/finance/transactions' },
      { name: 'Kalkulator Biaya Produk', path: '/app/craft/finance/calculator' },
      { name: 'Arus Kas', path: '/app/craft/finance/cash-flow' },
    ]},
    { name: 'Laporan & Analitik', icon: LayoutDashboard, path: '/app/craft/analytics' },
  ]},
  { label: 'SISTEM', items: [
    { name: 'Marketplace & Kanal Penjualan', icon: Network, path: '/app/craft/marketplace' },
...
const studioNav: NavGroup[] = [
  ...
  { label: 'OPERASIONAL', items: [
    { name: 'Proyek', icon: FolderKanban, path: '/app/studio/projects', subItems: [
    ...
    { name: 'Peralatan & Aset', icon: HardDrive, path: '/app/studio/equipment' },
  ]},
  { label: 'BISNIS', items: [
    { name: 'Penawaran & Penagihan', icon: FileText, path: '/app/studio/billing', subItems: [
      { name: 'Penawaran', path: '/app/studio/billing/quotations' },
      { name: 'Invoice', path: '/app/studio/billing/invoices' },
      { name: 'Tagihan Belum Dibayar', path: '/app/studio/billing/outstanding' },
    ]},
    { name: 'Vendor / Freelancer / Mitra', icon: Users, path: '/app/studio/vendors' },
    { name: 'Keuangan', icon: CircleDollarSign, path: '/app/studio/finance', subItems: [
      { name: 'Ringkasan Keuangan', path: '/app/studio/finance' },
      { name: 'Transaksi', path: '/app/studio/finance/transactions' },
    ]},
    { name: 'Laporan & Analitik', icon: LayoutDashboard, path: '/app/studio/analytics' },
  ]},
  { label: 'SISTEM', items: [
    { name: 'Otomasi', icon: Zap, path: '/app/studio/automations' },
  ]}
];
