  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        permission: "studio.finance.read",
        subItems: [
          { name: "Ringkasan Keuangan", path: "/app/studio/finance" },
          { name: "Transaksi", path: "/app/studio/finance/transactions" },
          { name: "Kas & Bank", path: "/app/studio/finance/treasury" },
          { name: "Pendapatan", path: "/app/studio/finance/income" },
          { name: "Pengeluaran", path: "/app/studio/finance/expenses" },
          { name: "Piutang Klien", path: "/app/studio/finance/receivables" },
          { name: "Kewajiban Vendor/Freelancer", path: "/app/studio/finance/payables" },
          { name: "Profitabilitas Proyek", path: "/app/studio/finance/profitability" },
          { name: "Arus Kas", path: "/app/studio/finance/cash-flow" },
          { name: "Anggaran", path: "/app/studio/finance/budgets" },
          { name: "Jurnal & Periode", path: "/app/studio/finance/accounting" },
        ],
      },
      {
        name: "Laporan & Analitik",
        ...
        permission: "studio.analytics.read",
        subItems: [
          { name: "Ringkasan Analitik", path: "/app/studio/analytics" },
          { name: "Proyek", path: "/app/studio/analytics/projects" },
          { name: "Klien", path: "/app/studio/analytics/clients" },
          { name: "Layanan", path: "/app/studio/analytics/services" },
          { name: "Penawaran & Penagihan", path: "/app/studio/analytics/commercial" },
          { name: "Pendapatan & Arus Kas", path: "/app/studio/analytics/revenue" },
          { name: "Profitabilitas", path: "/app/studio/analytics/profitability" },
          { name: "Piutang", path: "/app/studio/analytics/receivables" },
          { name: "Vendor / Freelancer", path: "/app/studio/analytics/vendors" },
          { name: "Peralatan & Aset", path: "/app/studio/analytics/equipment" },
        ],
      },
    ],
  },
